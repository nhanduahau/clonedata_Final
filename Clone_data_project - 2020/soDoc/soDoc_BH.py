...
#------------------------------------Số Đọc Chỉ Số--------------------------------------------
nameOfOutputFile ="Clone_data_project - 2020/sodoc/results/soDoc_BH.xlsx" 
with open("Clone_data_project - 2020/input_month.txt", 'r') as file:
...
time.sleep(2)
driver.find_element(By.XPATH,'/html/body/div[2]/div[4]/div/table/tbody/tr[15]/td/div').click()
time.sleep(3)
...
#-------------------------------------------
            ...
            for j in range(0,maxPage_c):
                ...
                for d in row:
                    print(d.find_elements(By.CSS_SELECTOR,"td.x-grid-cell")[4 ].text)
