...
import time
#------------------------------------Hóa Đơn--------------------------------------------
nameOfInputFile = "Clone_data_project/hopDong/results/soHopDong_BH.txt"
nameOfOutputFile ="Clone_data_project - 2020/hoaDon/results/HoaDon_BH.xlsx" 
...
driver.find_element(By.ID,'ext-gen1216').click()
time.sleep(1)
