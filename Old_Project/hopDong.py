...
time.sleep(1)
driver.find_element(By.ID,'ext-gen1201').click()
time.sleep(2)
    ...
    for i in range(len(row)):
        ...
        for j in range(len(data)):
            try:
                data[j].click()
                time.sleep(2)
                maTinh  = driver.find_element(By.NAME,"maTinh").get_attribute("value")
                maHuyen = driver.find_element(By.NAME,"maHuyen").get_attribute("value")
                maXa = driver.find_element(By.NAME,"maXa").get_attribute("value")
                maDMVung = driver.find_element(By.NAME,"maDMVung").get_attribute("value")
                maDMKhuVuc = driver.find_element(By.NAME,"maDMKhuVuc").get_attribute("value")
                maNhanVien = driver.find_elements(By.NAME,"maNhanVien")[1].get_attribute("value")
                maTuyenDoc = driver.find_elements(By.NAME,"maTuyenDoc")[1].get_attribute("value")
                maPhamVi = driver.find_elements(By.NAME,"maPhamVi")[1].get_attribute("value")
                maDongHo = driver.find_element(By.NAME,"maDongHo").get_attribute("value")
                maDongHoCha = driver.find_element(By.NAME,"maDongHoCha").get_attribute("value")
                laDongHoPhu = isCheck(table,"DHP")
                soThuTu = driver.find_element(By.NAME,"soThuTu").get_attribute("value")
                seri = driver.find_elements(By.NAME,"seri")[1].get_attribute("value")
                chiSoDau = driver.find_element(By.NAME,"chiSoDau").get_attribute("value")
                chiSoCuoi = driver.find_element(By.NAME,"chiSoCuoi").get_attribute("value")
                seriChi = driver.find_element(By.NAME,"seriChi").get_attribute("value")
                ngayLapDatDongHo = driver.find_element(By.NAME,"ngayLapDatDongHo").get_attribute("value")
                ngayBatDauSuDung = driver.find_element(By.NAME,"ngayBatDauSuDung").get_attribute("value")
                diaChi2 = driver.find_elements(By.NAME,"diaChi")[1].get_attribute("value")
                maTinhTrangDongHo = driver.find_element(By.NAME,"maTinhTrangDongHo").get_attribute("value")
                lyDoHuy = driver.find_element(By.NAME,"lyDoHuy").get_attribute("value")
                ngayBatDauNgung = driver.find_element(By.NAME,"ngayBatDauNgung").get_attribute("value")
                ngayKetThucSuDung = driver.find_element(By.NAME,"ngayKetThucSuDung").get_attribute("value")
                maDMNuocSanXuat = driver.find_element(By.NAME,"maDMNuocSanXuat").get_attribute("value")
                maDMHangSanXuat = driver.find_element(By.NAME,"maDMHangSanXuat").get_attribute("value")
                maDMKieuDongHo = driver.find_element(By.NAME,"maDMKieuDongHo").get_attribute("value")
                duongKinh = driver.find_element(By.NAME,"duongKinh").get_attribute("value")
                maDMHopBaoVeDongHo = driver.find_element(By.NAME,"maDMHopBaoVeDongHo").get_attribute("value")
                viTriLapDat = driver.find_element(By.NAME,"viTriLapDat").get_attribute("value")
                ngayKiemDinh = driver.find_element(By.NAME,"ngayKiemDinh").get_attribute("value")
                ngayHieuLucKiemDinh = driver.find_element(By.NAME,"ngayHieuLucKiemDinh").get_attribute("value")
                lyDoKiemDinh = driver.find_element(By.NAME,"lyDoKiemDinh").get_attribute("value")
                vanMotChieu = driver.find_element(By.NAME,"vanMotChieu").get_attribute("value")
                tem = driver.find_element(By.NAME,"tem").get_attribute("value")
                soPhieuThay = driver.find_element(By.NAME,"soPhieuThay").get_attribute("value")
                hinhThucXuLy = driver.find_element(By.NAME,"hinhThucXuLy").get_attribute("value")
                lyDoThay = driver.find_element(By.NAME,"lyDoThay").get_attribute("value")
                maDongHoThay = driver.find_element(By.NAME,"maDongHoThay").get_attribute("value")
                nguoiThay = driver.find_element(By.NAME,"nguoiThay").get_attribute("value")
                xDaiDien = driver.find_element(By.NAME,"xDaiDien").get_attribute("value")
                yDaiDien = driver.find_element(By.NAME,"yDaiDien").get_attribute("value")
                loaiKhuyenMai = driver.find_element(By.NAME,"loaiKhuyenMai").get_attribute("value")
                soNuocKhuyenMaiConLai = driver.find_element(By.NAME,"soNuocKhuyenMaiConLai").get_attribute("value")
                trangThaiDongHo = driver.find_element(By.NAME,"trangThaiDongHo").get_attribute("value")
                ongDan = driver.find_element(By.NAME,"ongDan").get_attribute("value")
                daiKhoiThuy = driver.find_element(By.NAME,"daiKhoiThuy").get_attribute("value")
                ...
                f.write("error at page "+ str(page) + " row " + str(i+1) +" data " +str(j+1)+".\n")
                f.close()
            count +=1
