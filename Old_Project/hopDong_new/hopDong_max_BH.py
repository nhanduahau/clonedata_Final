...
STARPAGE = 1
ENDPAGE = 25 #max 25
nameOfOutputFileExcel ="hopDong_max_BH.xlsx"
nameOfOutputFileText = "soHopDong_max_BH.txt"
GETMAXMODE = 1 # 1.on || 0.off
GETMAX = 1204 # input row
#--------------------------------------------------------------------------------
...
while(page!=ENDPAGE+1):
    if(stt == GETMAX + 1 and GETMAXMODE == 1):
            break
