...
workbook = xlsxwriter.Workbook("hopDong-tatCaNhaMay"+str(STARPAGE)+"-"+str(ENDPAGE)+".xlsx")
...
worksheet.write('H1 ', 'Nhà mạng')     
worksheet.write('I1 ', 'Số điện thoại')     
worksheet.write('J1 ', 'Số CMND')     
worksheet.write('K1 ', 'Ngày cấp CMND')     
worksheet.write('L1 ', 'Nơi cấp CMND')     
worksheet.write('M1 ', 'Mã số thuế')     
worksheet.write('N1 ', 'Tên ngân hàng')     
worksheet.write('O1 ', 'Số GCN')     
worksheet.write('P1 ', 'Tên TKNH')     
worksheet.write('Q1 ', 'Số TKNH')     
worksheet.write('R1 ', 'Nguồn nước')     
worksheet.write('S1 ', 'Người đại điện')     
worksheet.write('T1 ', 'Ghi chú')     
worksheet.write('U1 ', 'Đối tượng')     
worksheet.write('V1 ', 'Mã đăng ký')    
worksheet.write('W1 ', 'Số hợp đồng')    
worksheet.write('X1 ', 'ĐT giá')    
worksheet.write('Y1 ', 'Mục đích SD')    
worksheet.write('Z1 ', 'Khu vực TT')    
worksheet.write('AA1', 'Hình thức TT')    
worksheet.write('AB1', 'Mã vạch')    
worksheet.write('AC1', 'Ngày ký HĐ')    
worksheet.write('AD1', 'Ngày lắp đặt')    
worksheet.write('AE1', 'Người lắp đặt')    
worksheet.write('AF1', 'Ngày NT')    
worksheet.write('AG1', 'Tiền lắp đặt')    
worksheet.write('AH1', 'Người nộp')    
worksheet.write('AI1', 'Tiền đặt cọc')    
worksheet.write('AJ1', 'Giảm trừ theo')    
worksheet.write('AK1', 'Số tiền giảm trừ')    
worksheet.write('AL1', 'Ngày đặt cọc')    
worksheet.write('AM1', 'Chứng từ đặt cọc')    
worksheet.write('AN1', 'Cam kết sử dụng nước')    
worksheet.write('AO1', 'Khối lượng cam kết')    
worksheet.write('AP1', 'Ghi chú hợp đồng')    
worksheet.write('AQ1', 'Tỉnh')    
worksheet.write('AR1', 'Huyện')    
worksheet.write('AS1', 'Xã')    
worksheet.write('AT1', 'Vùng')    
worksheet.write('AU1', 'Khu vực')    
worksheet.write('AV1', 'Nhân viên')    
worksheet.write('AW1', 'Tuyến đọc')    
worksheet.write('AX1', 'Phạm vi')    
worksheet.write('AY1', 'Mã đồng hồ')    
worksheet.write('AZ1', 'Đồng hồ block')    
worksheet.write('BA1', 'Là đồng hồ phụ')    
worksheet.write('BB1', 'Số thứ tự')    
worksheet.write('BC1', 'Seri')    
worksheet.write('BD1', 'Chỉ số đầu')    
worksheet.write('BE1', 'Chỉ số cuối')    
worksheet.write('BF1', 'Seri chỉ')    
worksheet.write('BG1', 'Ngày lắp đặt đồng hồ')    
worksheet.write('BH1', 'Ngày sử dụng')    
worksheet.write('BI1', 'Địa chỉ')    
worksheet.write('BJ1', 'Trạng thái')    
worksheet.write('BK1', 'Lý do hủy')    
worksheet.write('BL1','Ngày BĐ ngừng')    
worksheet.write('BM1','Ngày kết thúc')    
worksheet.write('BN1', 'Nước SX')    
worksheet.write('BO1', 'Hãng SX')    
worksheet.write('BP1', 'Kiểu đồng hồ')    
worksheet.write('BQ1', 'Đường kính')    
worksheet.write('BR1', 'Hộp bảo vệ')    
worksheet.write('BS1', 'Vị trí lắp đặt')    
worksheet.write('BT1', 'Ngày kiểm định')    
worksheet.write('BU1', 'Hiệu lực KĐ')    
worksheet.write('BV1', 'Lý do kiểm định')    
worksheet.write('BW1', 'Van một chiều')    
worksheet.write('BX1', 'Số Tem')    
worksheet.write('BY1', 'Số phiếu thay')    
worksheet.write('BZ1', 'Hình thức XL')    
worksheet.write('CA1', 'Lý do thay')    
worksheet.write('CB1', 'Mã ĐH thay')    
worksheet.write('CC1', 'Người thay')    
worksheet.write('CD1', 'Kinh độ')    
worksheet.write('CE1', 'Vĩ độ')    
worksheet.write('CF1', 'Lọa KM')    
worksheet.write('CG1', 'Khuyến mãi')    
worksheet.write('CH1', 'Trạng thái ĐH lắp')    
worksheet.write('CI1', 'Ống dẫn')    
worksheet.write('CJ1', 'Đai khởi thủy')    
...
def save():
    ...
    worksheet.write(count, 7 ,tenNhaMang)
    worksheet.write(count, 8 ,dienThoai)
    worksheet.write(count, 9 ,soCMND)
    worksheet.write(count, 10, ngayCapCMND)
    worksheet.write(count, 11, noiCapCMND)
    worksheet.write(count, 12, maSoThue)
    worksheet.write(count, 13,tenNganHang)
    worksheet.write(count, 14,soGCN)
    worksheet.write(count, 15,tenTaiKhoanNH)
    worksheet.write(count, 16,taiKhoanNganHang)
    worksheet.write(count, 17,nguonNuocKhac)
    worksheet.write(count, 18, nguoiDaiDien)
    worksheet.write(count, 19, ghiChu)
    worksheet.write(count, 20, doiTuong)
    worksheet.write(count, 21, maDangKyLapDat)
    worksheet.write(count, 22, soHopDong)
    worksheet.write(count, 23, maDoiTuongGia)
    worksheet.write(count, 24, mucDich)
    worksheet.write(count, 25,maKhuVucThanhToan)
    worksheet.write(count, 26, maPhuongThucThanhToan)
    worksheet.write(count, 27, maVach)
    worksheet.write(count, 28, ngayKy)
    worksheet.write(count, 29, ngayLapDat)
    worksheet.write(count, 30, nguoiLapDat)
    worksheet.write(count, 31, ngayBanGiao)
    worksheet.write(count, 32, soTien)
    worksheet.write(count, 33, nguoiNop)
    worksheet.write(count, 34, tienDatCoc)
    worksheet.write(count, 35, loaiGiamTru)
    worksheet.write(count, 36, soTienGiamTru)
    worksheet.write(count, 37, ngayDatCoc)
    worksheet.write(count, 38, chungTuDatCoc)
    worksheet.write(count, 39, camKetSuDungNuoc)
    worksheet.write(count, 40, khoiLuongCamKet)
    worksheet.write(count, 41, ghiChuHD)
    worksheet.write(count, 42, maTinh)
    worksheet.write(count, 43, maHuyen)
    worksheet.write(count, 44, maXa)
    worksheet.write(count, 45, maDMVung)
    worksheet.write(count, 46, maDMKhuVuc)
    worksheet.write(count, 47, maNhanVien)
    worksheet.write(count, 48, maTuyenDoc)
    worksheet.write(count, 49, maPhamVi)
    worksheet.write(count, 50, maDongHo)
    worksheet.write(count, 51, maDongHoCha)
    worksheet.write(count, 52, laDongHoPhu)
    worksheet.write(count, 53, soThuTu)
    worksheet.write(count, 54,seri)
    worksheet.write(count, 55, chiSoDau)
    worksheet.write(count, 56, chiSoCuoi)
    worksheet.write(count, 57, seriChi)
    worksheet.write(count, 58, ngayLapDatDongHo)
    worksheet.write(count, 59, ngayBatDauSuDung)
    worksheet.write(count, 60, diaChi2)
    worksheet.write(count, 61, maTinhTrangDongHo)
    worksheet.write(count, 62, lyDoHuy)
    worksheet.write(count, 63, ngayBatDauNgung)
    worksheet.write(count, 64, ngayKetThucSuDung)
    worksheet.write(count, 65, maDMNuocSanXuat)
    worksheet.write(count, 66, maDMHangSanXuat)
    worksheet.write(count, 67, maDMKieuDongHo)
    worksheet.write(count, 68, duongKinh)
    worksheet.write(count, 69, maDMHopBaoVeDongHo)
    worksheet.write(count, 70, viTriLapDat)
    worksheet.write(count, 71, ngayKiemDinh)
    worksheet.write(count, 72, ngayHieuLucKiemDinh)
    worksheet.write(count, 73, lyDoKiemDinh)
    worksheet.write(count, 74, vanMotChieu)
    worksheet.write(count, 75, tem)
    worksheet.write(count, 76, soPhieuThay)
    worksheet.write(count, 77, hinhThucXuLy)
    worksheet.write(count, 78, lyDoThay)
    worksheet.write(count, 79, maDongHoThay)
    worksheet.write(count, 80, nguoiThay)
    worksheet.write(count, 81, xDaiDien)
    worksheet.write(count, 82, yDaiDien)
    worksheet.write(count, 83, loaiKhuyenMai)
    worksheet.write(count, 84, soNuocKhuyenMaiConLai)
    worksheet.write(count, 85, trangThaiDongHo)
    worksheet.write(count, 86, ongDan)
    worksheet.write(count, 87, daiKhoiThuy)
...
while(page!=ENDPAGE+1):
    ...
    for i in range(len(row)):
        ...
        for j in range(len(data)):
            ...
            save()
            count +=1
        f = open("soHopDong_tatCaNhaMay.txt", "a")
        f.write(soHopDong+"\n")
        f.close()
